...
\centerline{\includegraphics[width=0.8\textwidth]{postgres_architecture.pdf}}
...
\centerline{\includegraphics[width=0.18\textwidth]{database-interconnected-svgrepo-com.pdf}}
...
\centerline{\includegraphics[width=1.0\textwidth]{pg_shared_private_memory.pdf}}

% =========================================
\newpage
\section{Shared Buffers}
\centerline{\includegraphics[width=1.0\textwidth]{pg_shared_buffers.pdf}}

% =========================================
\newpage
\section{Database Layout}
\centerline{\includegraphics[width=1.0\textwidth]{pg_database_layout.pdf}}

% =========================================
\newpage
\section{Data Block/Page Layout}
\centerline{\includegraphics[width=0.8\textwidth]{data_block_layout.pdf}}
...
\end{itemize}
\centerline{\includegraphics[width=0.8\textwidth]{memory1.pdf}}
...
\end{itemize}
\centerline{\includegraphics[width=0.8\textwidth]{byte_range.pdf}}
...
\end{itemize}
\centerline{\includegraphics[width=1.0\textwidth]{memory_model.pdf}}
...
\begin{itemize}
	\item Offset within an array is an integer indicating the distance between the beginning of the object and a given element.
\end{itemize}
\centerline{\includegraphics[width=1.0\textwidth]{shared_memory_overview.pdf}}
...
\centerline{\includegraphics[width=1.0\textwidth]{source_compile.pdf}}
...
\begin{itemize}
	\item X.
\end{itemize}
\centerline{\includegraphics[width=1.0\textwidth]{process.pdf}}
...
\begin{itemize}
	\item X.
\end{itemize}
\centerline{\includegraphics[width=1.0\textwidth]{fork_process.pdf}}
